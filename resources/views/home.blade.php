    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-7">
                <h4 class="student-heading">{{ __('Free Courses') }}</h4>
            </div>
            <div class="col-lg-6 col-md-6 col-5">
                <div class="view-button txt-rgt">
                    <a href="{{url('free/view')}}" class="btn btn-secondary" title="View More">{{ __('View More') }}<i data-feather="chevrons-right"></i>
                    </a>
                </div>
            </div>
        </div>
        <div id="discounted-view-slider" class="student-view-slider-main-block owl-carousel">
            ...
            <div class="item student-view-block student-view-block-1">
                <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif"
                    ...
                    data-pt-title="#prime-next-item-description-block{{$free->id}}">
                    <div class="view-block">
                        <div class="view-img">
                            @if($free['preview_image'] !== NULL && $free['preview_image'] !== '')
                            <a href="{{ route('user.course.show',['id' => $free->id, 'slug' => $free->slug ]) }}"><img
                                    data-src="{{ asset('images/course/'.$free['preview_image']) }}" alt="course"
                                    class="img-fluid owl-lazy"></a>
                            @else
                            <a href="{{ route('user.course.show',['id' => $free->id, 'slug' => $free->slug ]) }}"><img
                                    data-src="{{ Avatar::create($free->title)->toBase64() }}" alt="course"
                                    class="img-fluid owl-lazy"></a>
                            @endif
                        </div>

                            
                            @if($free['level_tags'] == 'masters')
                            <div class="advance-badge">
                                <span class="badge bg-warning">{{__('Masters')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'featured')
    
                            <div class="advance-badge">
                                <span class="badge bg-danger">{{__('Featured')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'new')
    
                            <div class="advance-badge">
                                <span class="badge bg-success">{{__('New')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'onsale')
    
                            <div class="advance-badge">
                                <span class="badge bg-info">{{__('On-sale')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'bestseller')
    
                            <div class="advance-badge">
                                <span class="badge bg-success">{{__('Bestseller')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'beginners')
    
                            <div class="advance-badge">
                                <span class="badge bg-primary">{{__('Beginners')}}</span>
                            </div>
                            @endif
                            @if($free['level_tags'] == 'professionals')
    
                            <div class="advance-badge">
                                <span class="badge bg-success">{{__('Professionals')}}</span>
                            </div>
                            @endif
                        <div class="view-user-img">

                            @if(optional($free->user)['user_img'] !== NULL && optional($free->user)['user_img'] !== '')
                            <a href="{{ route('all/profile',$free->user->id) }}" title=""><img src="{{ asset('images/user_img/'.$free->user['user_img']) }}"
                                    class="img-fluid user-img-one" alt=""></a>
                            @else
                            <a href="{{  route('all/profile',$free->id)  }}" title=""><img src="{{ asset('images/default/user.png') }}"
                                    class="img-fluid user-img-one" alt=""></a>
                            @endif
                        </div>
                        @if(isset($free->user->id))
                        <div class="view-dtl">
                            <div class="view-heading"><a
                                    href="{{ route('user.course.show',['id' => $free->id, 'slug' => $free->slug ]) }}">{{ str_limit($free->title, $limit = 30, $end = '...') }}</a>
                            </div>
                            <div class="user-name">
                                <h6>By <span><a href="{{ route('all/profile',$free->user->id) }}"> {{ optional($free->user)['fname'] }}</a></span></h6>
                            </div>
                            <div class="rating">
                                <ul>
                                    <li>
                                        <?php 
                                            ...
                                            $sub_total = 0;
                                            $sub_total = 0;
                                            $reviews = App\ReviewRating::where('course_id',$free->id)->get();
                                            ?>
                                        @if(!empty($reviews[0]))
                                        <?php
                                            $count =  App\ReviewRating::where('course_id',$free->id)->count();
                                    ...
                                    <?php 
                                        ...
                                        $reviewcount = App\ReviewRating::where('course_id', $free->id)->WhereNotNull('review')->get();
                                    ...
                                    @php
                                    $reviewsrating = App\ReviewRating::where('course_id', $free->id)->first();
                                    @endphp
                                    ...
                                    <li class="reviews">
                                        (@php
                                        $data = App\ReviewRating::where('course_id', $free->id)->count();
                                        if($data>0){
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="count-user">
                                            <i data-feather="user"></i><span>
                                                @php
                                                $data = App\Order::where('course_id', $free->id)->count();
                                                if(($data)>0){
                                ...
                                <div class="protip-wishlist">
                                    <ul>
                                        ...
                                        <li class="protip-wish-btn"><a
                                                href="https://calendar.google.com/calendar/r/eventedit?text={{ $free['title'] }}"
                                                target="__blank" title="reminder"><i data-feather="bell"></i></a></li>

                                        @if(Auth::check())

                                        <li class="protip-wish-btn"><a class="compare" data-id="{{filter_var($free->id)}}"
                                        ...
                                        <li class="protip-wish-btn">
                                            <form id="demo-form2" method="post"
                                                action="{{ url('show/wishlist', $free->id) }}" data-parsley-validate
                                                class="form-horizontal form-label-left">
                                                {{ csrf_field() }}

                                                <input type="hidden" name="user_id" value="{{Auth::User()->id}}" />
                                                <input type="hidden" name="course_id" value="{{$free->id}}" />
                                        ...
                                        <li class="protip-wish-btn-two">
                                            <form id="demo-form2" method="post"
                                                action="{{ url('remove/wishlist', $free->id) }}" data-parsley-validate
                                                class="form-horizontal form-label-left">
                                                {{ csrf_field() }}
                ...
                <div id="prime-next-item-description-block{{$free->id}}" class="prime-description-block">
                    <div class="prime-description-under-block">
                        <div class="prime-description-under-block">
                            <h5 class="description-heading">{{ $free['title'] }}</h5>
                            <div class="main-des">
                                <p>Last Updated: {{ date('jS F Y', strtotime($free->updated_at)) }}</p>
                            </div>
                            ...
                            <ul class="description-list">
                                <li>
                                    ...
                                    <div class="class-des">
                                        {{ __('Classes') }}:
                                        @php
                                        $data = App\CourseClass::where('course_id', $free->id)->count();
                                        if($data > 0){
                                ...
                                <li>
                                    <div class="lang-des">
                                        @if($free['language_id'] == !NULL)
                                        @if(isset($c->language))
                                        <i data-feather="globe"></i> {{ $free->language['name'] }}
                                        @endif
                                        @endif
                                    </div>
                                </li>
                            ...
                            <div class="product-main-des">
                                <p>{{ $free->short_detail }}</p>
                            </div>
                            <div>
                                @if($free->whatlearns->isNotEmpty())
                                @foreach($free->whatlearns as $wl)
                                @if($wl->status ==1)
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="protip-btn">
                                            <a href="{{ route('course.content',['id' => $free->id, 'slug' => $free->slug ]) }}"
                                        ...
                                        <div class="protip-btn">
                                            <form id="demo-form2" method="post"
                                                action="{{ route('addtocart',['course_id' => $free->id, 'price' => $free->price, 'discount_price' => $free->discount_price ]) }}"
                                                data-parsley-validate class="form-horizontal form-label-left">
                                                {{ csrf_field() }}

                                                <input type="hidden" name="category_id"
                                                    value="{{$free->category['id'] ?? '-'}}" />
                                        ...
                                        <form id="demo-form2" method="post"
                                            action="{{ route('guest.addtocart', $free->id) }}" data-parsley-validate
                                            class="form-horizontal form-label-left">
                                            {{ csrf_field() }}
                                        ...
                                        @if($enroll == NULL)
                                        <div class="protip-btn">
                                            <a href="{{url('enroll/show',$free->id)}}" class="btn btn-primary"
                                        ...
                                        <div class="img-wishlist">
                                            <div class="protip-wishlist">
                                                <ul>
                                                    ...
                                                    Auth::User()->id)->where('course_id', $free->id)->first();
                                                    @endphp
                                                    @if ($wish == NULL)
                                                    <li class="protip-wish-btn">
                                                        <form id="demo-form2" method="post"
                                                            action="{{ url('show/wishlist', $free->id) }}"
                                                    ...
                                                    <li class="protip-wish-btn-two">
                                                        <form id="demo-form2" method="post"
                                                            action="{{ url('remove/wishlist', $free->id) }}"
                                                            data-parsley-validate
                                                            class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}
