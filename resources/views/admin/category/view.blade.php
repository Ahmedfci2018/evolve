...
>
            ...
            <div class="modal-body">
              <form id="demo-form" method="post" action="{{url('category/'.$cat->id)}}
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input pattern="[/^\S*$/]+" placeholder="Please Enter slug" type="text"
                        class="form-control" name="slug"  value="{{$cat->slug}}">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                  <button type="reset" class="btn btn-danger-rgba"><i class="fa fa-ban" title="{{ __('Reset') }}"
></i>
                    {{ __('Reset') }}</button>
                  <button type="submit" class="btn btn-primary-rgba" title="{{ __('Update') }}"
