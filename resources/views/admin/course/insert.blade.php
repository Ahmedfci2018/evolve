          ...
          <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="title" class="form-control" name="title" id="exampleInputTitle" placeholder="{{ __('Enter Course Name') }}" value="{{ (old('title')) }}" >
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <textarea name="short_detail" rows="3" class="form-control" placeholder="{{ __('Enter Short Detail') }}" >{{ (old('short_detail')) }}</textarea>
              </div>
              <div class="col-md-6">
                <label for="exampleInputTit1e">{{ __('Requirements') }}: <sup class="redstar"></sup></label>
                <textarea name="requirement" rows="3" class="form-control" placeholder="{{ __('Enter Requirements') }}" >{{ (old('requirement')) }}</textarea>
              </div>
            </div>
            <br>
